...
//   return (
//     // Main container - removed fixed height (h-[755px])
//     <div className='flex flex-col items-center w-full max-w-6xl mx-auto px-4 py-16 text-gray-300 gap-20'>

//       {/* --- Title Section --- */}
//       <h2 className="relative text-5xl font-semibold px-10 py-5 text-white ">
//         <span
//           className="absolute bottom-0 left-0 w-12 h-14 border-b-4 border-l-4 border-[#50790B] rounded-bl-xl"
//         />
//         Our Best o2
//         <span
//           className="absolute top-0 right-0 w-12 h-14 border-t-4 border-r-4 border-[#50790B] rounded-tr-xl"
//         />
//       </h2>

//       {/* --- Main Content Card --- */}
//       {/* Added 'relative' to main card for image positioning */}
//       <div className="relative bg-[#333D33]/60 rounded-[70px] backdrop-blur-md p-12 border-l-2 border-r-2 border-white/20 w-full flex flex-row items-stretch gap-12 shadow-lg min-h-[550px]"> {/* min-h for consistent card size */}

//         {/* Left Side: Image container - Made relative for overlapping image */}
//         <div className="w-1/2 relative min-h-[400px]"> {/* Added min-h for image container */}
//           <img
//             src={currentSlide.imgSrc}
//             alt="Best O2 Plant"
//             className='absolute -left-6 top-1/2 -translate-y-1/2 w-[550px] h-[650px] object-contain' // Adjusted top for better vertical centering
//             onError={(e) => e.target.src = 'https://placehold.co/600x600/2A332A/FFFFFF?text=Image+Error'}
//           />
//         </div>

//         {/* Right Side: Text Content */}
//         {/* Added 'justify-between' so content stretches vertically */}
//         <div className="w-3/5 flex flex-col justify-between gap-4 ml-auto py-4"> {/* Removed min-h from here, added py */}

//           <div> {/* Wrapper for text content to group it */}
//             <h2 className='font-semibold text-4xl text-white'>{currentSlide.heading}</h2>

//             <p className='font-light text-lg text-gray-300 mt-4'> {/* Added mt-4 for spacing */}
//               {currentSlide.p1}
//             </p>

//             <p className='font-light text-lg text-gray-300 mt-2'> {/* Added mt-2 for spacing */}
//               {currentSlide.p2}
//             </p>
//           </div>

//           {/* Button and Pagination Row - mt-auto removed, justify-between handles spacing */}
//           <div className="flex items-center justify-between">
//             <button className="font-normal text-lg border border-white px-8 py-2 rounded-lg hover:bg-white/10 text-white transition-colors cursor-pointer">
//               Explore
//             </button>
...
//                 className="p-2 border border-white/30 rounded-full text-white hover:bg-white/10"
//               >
//                 <ChevronLeft size={20} />
//               </button>
//               <button
